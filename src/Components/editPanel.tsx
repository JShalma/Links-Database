export default function EditPanel(){
    return (
        // category-btn black-border min-w-full
        <section className="flex items-center gap-10 h-full">
            <div className="flex gap-4">
                <div className="edit-btn p-1.5 rounded-3xl">
                ...
                {/* <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-x-lg edit-btn" viewBox="0 0 16 16">
                    <path strokeWidth={20} d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8z"/>
                </svg> */}
                <span className="pt-2">1 selected</span>
            </div>
            <div className="flex gap-5">
                <div className="edit-btn p-1.5 rounded-2xl">
                ...
                <div className="edit-btn p-1.5 rounded-2xl">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-folder-symlink" viewBox="0 0 16 16">
