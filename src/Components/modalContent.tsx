...
export function MoveModal({ content, setIsModalOpen, onMove } : { content: TreeNode,  setIsModalOpen:(open:boolean) => void, onMove: (item:TreeNode, updatedParentId:string) => void }){
    
    function handleMove(e:MouseEvent){
        e.preventDefault();
        onMove(content, "521c7303-b07b-4266-b46f-171caaed21df");
        setIsModalOpen(false);
    }
